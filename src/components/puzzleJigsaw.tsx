...
function DroppableSlot({
  ...
  // Generate outline path for empty slots
  let outlinePath = '';
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: 0,
        overflow: 'visible',
        // Ensure pieces are above background but maintain proper stacking
        zIndex: isEmpty ? 1 : (row * 10 + col + 10),
      }}
    >
      {/* Puzzle shape outline for empty slots */}
      ...
      {/* Simple dashed outline for rectangle mode */}
...
export default function PuzzleJigsaw({
  ...
  showGuideImage = true, // Show background guide image
  guideOpacity = 0.3, // Opacity of guide image (0-1)
}) {
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg text-sm text-gray-700">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>✅ Background guide image membantu anak-anak menempatkan piece dengan mudah</li>
          <li>✅ Puzzle shape outline menunjukkan bentuk piece yang harus ditempatkan</li>
          <li>Set <code className="bg-gray-200 px-1 rounded">usePuzzleShapes=true</code> untuk bentuk puzzle piece</li>
          <li>Set <code className="bg-gray-200 px-1 rounded">showGuideImage=true</code> untuk menampilkan gambar panduan</li>
          <li>Set <code className="bg-gray-200 px-1 rounded">guideOpacity=0.3</code> untuk mengatur transparansi panduan (0-1)</li>
        </ul>
      </div>
    </div>
  );
